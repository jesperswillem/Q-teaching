...
qdyn=/home/willem/software/q6/bin/qdyn
fepfiles=(FEP1.fep)
temperature=298
run=10
finalMDrestart=md_0000_1000.re

workdir=/home/willem/software/qgpu/benchmark/2.physical-properties/1.solvation/1.Q-cpu/2.vacuum/FEP_HIP-ALA
inputfiles=/home/willem/software/qgpu/benchmark/2.physical-properties/1.solvation/1.Q-cpu/2.vacuum/FEP_HIP-ALA/inputfiles
length=${#fepfiles[@]}
length=$((length-1))
...
timeout 30s /home/willem/software/q6/bin/qfep < qfep.inp > qfep.out
done
